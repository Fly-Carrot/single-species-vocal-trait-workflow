...
**[中文指南](README.zh-CN.md) · [Start the lessons](docs/00-orientation.md) · [Audition](docs/09-audition-audio-preparation.md) · [Avisoft](docs/10-avisoft-vocal-trait-measurement.md) · [Run the analysis](analysis/README.md)**
